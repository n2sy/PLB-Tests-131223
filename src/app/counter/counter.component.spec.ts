...
describe('CounterComponent', () => {
  ...
  it('Reset du compteur', () => {
    ...
    const element2 = fixture.debugElement.query(By.css('#increment-reset'));
    element2.triggerEventHandler('click');
    fixture.detectChanges();
    expect(document.querySelector('#count').textContent).toBe(String(randomValue));
  });

  it('Recuperer le data avec succès aprés un appel asynchrone', waitForAsync(() => {
    fixture.detectChanges();
    fixture.whenStable().then(() => {
      expect(component.data).toBe('Data recupere');
    });
  }));
  

  it('Recuperer le data avec succès aprés un appel asynchrone V2', fakeAsync(() => {
    let countSer = TestBed.inject(CountService);
    spyOn(countSer, 'getData').and.returnValue(
      Promise.resolve('Data recupere'));
    fixture.detectChanges();
